...
local disable_pv   = false  -- operator opt-out: when a second Zap (or
                             -- another driver) already owns PV on the
                             -- site, set `disable_pv: true` to skip PV
                             -- discovery + emit and avoid double-count.
