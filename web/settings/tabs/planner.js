  ...
  S.tabs.planner = {
    render: function (ctx) {
      ...
      return '<fieldset><legend>MPC Planner</legend>' +
        ...
        '<p style="color:var(--text-dim);font-size:0.8rem;margin:4px 0 12px 0">' +
        'Mode (self_consumption / cheap_charge / arbitrage) is set from the Control page — pick one of the planner_* modes there. This tab only owns the scalar tunables.' +
        '</p>' +
