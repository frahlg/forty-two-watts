...
| CTEK Chargestorm (API v1) | CTEK | Modbus + MQTT | ev | yes | Chargestorm Connected 2/3 (CSOS ≥ 4.9.3) | `drivers/ctek.lua` |
| CTEK Chargestorm (API v2) | CTEK | Modbus + MQTT | ev | yes | Chargestorm Connected 2/3 (CSOS ≥ 4.9.3) | `drivers/ctek_v2.lua` |
